...
classify_population <- function(exposure_icd10 = "", # TODO oisko tähän funktioon attribuutti: response_other = list(DGREG = "FRACTURES", DG = "hip")
                                ...
                                exposure_icd8 = "",
                                exposure_src = c(""),
                                age_range_exp= c(0,120),
                                censoring_date_exp="",
                                response_icd10 = NULL,
                                response_icd9 = NULL,
                                response_icd8 = NULL,
                                response_src = c(""),
                                age_range_resp= c(0,120),
                                censoring_date_resp="",
  ...
  all <- function() {
    ...
    exp <- .group_by_diagnosis(regex_icd10 = exposure_icd10,
                               ...
                               age_range=age_range_exp,
                               censoring_date=censoring_date_exp,
    ...
    if (has_response) {
      ...
      resp <- .group_by_diagnosis(regex_icd10 = response_icd10,
                                  ...
                                  age_range=age_range_resp,
                                  censoring_date=censoring_date_resp,
