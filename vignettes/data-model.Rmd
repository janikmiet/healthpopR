...
`healthpopR` functions uses follow up datasets, which have fixed variable names. This document describes variables and names. Here you can get idea of the shape of the datasets needed.
